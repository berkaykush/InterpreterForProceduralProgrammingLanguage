...
from src.errors.error import SemanticError
from src.lexer.tokens import Token
from src.parser.abstract_syntax_tree import AccessNode, AssignmentStatementNode, VarNode
from src.parser.visit_ast_node import ASTNodeVisitor
from src.semantic_analyzer.symbol_table import (
    BuiltInFuncSymbol,
    BuiltInTypeSymbol,
    ConditionalSymbol,
    FuncSymbol,
...
from src.semantic_analyzer.type_checker import TypeChecker
...
class SemanticAnalyzer(ASTNodeVisitor):
    ...
    def visitRangeExprNode(self, ast_node):
        return TypeChecker.check_range_expr(
            ...
            step_type=(
                self.visit(ast_node.step_node).name if ast_node.step_node else None
            ),
