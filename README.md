...
![Python_Version-3.11.9-brown](https://img.shields.io/badge/Python_Version-3.11.9-brown.svg)
...
```text
────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
 File: compact_grammar/grammar.txt
────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
...
```text
───────┬─────────────────────────────────────────────────────────────────────────────────────────────────────────────
       │ File: compact_example_programs/factorial.co
───────┼─────────────────────────────────────────────────────────────────────────────────────────────────────────────
...
```text
───────┬─────────────────────────────────────────────────────────────────────────────────────────────────────────────
       │ File: compact_example_programs/check_num_occurrences.co
───────┼─────────────────────────────────────────────────────────────────────────────────────────────────────────────
...
cd InterpreterForProceduralProgrammingLanguage
python main.py compact_example_programs/program_name.co
```
